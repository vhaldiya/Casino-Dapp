...
//this.state.ContractInstance = MyContract.at("0xab13609410b5fc789c2416100836c31070982d2a");
this.state.ContractInstance = MyContract.at("0xb0340ec8c2e12347704a4278a8c689624e2bdaa3");
	window.a = this.state
	//window.b = web3
   }
    componentDidMount(){
